...
import { Clock, Shield, Plus, ShoppingCart, X, Trophy, TrendingUp } from 'lucide-react';
import { formatNumber, formatNumberWithDots, getPositionName, getPositionColor } from '../../../utils/helpers';
import { getClauseStatusColor, getClauseTimeRemaining, isClauseExpiringSoon } from '../../../utils/clauseUtils';
...
const PlayerRow = ({
    ...
    const clauseOpen = !playerTeam.buyoutClauseLockedEndTime ||
        new Date(playerTeam.buyoutClauseLockedEndTime) <= new Date();
